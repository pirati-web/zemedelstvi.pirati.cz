                        ...
                        <div class="c-BasicPage-content">
                            <ul class="c-simple-accordion" data-accordion="" data-options="allowAllClosed: true">
                                <li class="c-simple-accordion-item is-active" data-accordion-item="">
                                  <a href="#garant" class="c-simple-accordion-title"><h3>GARANT PROGRAMOVÉHO BODU</h3></a>
                                ...
                                <li class="c-simple-accordion-item" data-accordion-item="">
                                    <a href="#snemovna" class="c-simple-accordion-title"><h3>POSLANCI A POSLANKYNĚ</h3></a>
                                ...
                                <li class="c-simple-accordion-item" data-accordion-item="">
                                    <a href="#ketvysocina" class="c-simple-accordion-title"><h3>EXPERTI RESORTU - KRAJ VYSOČINA</h3></a>
                                ...
                                <li class="c-simple-accordion-item  content-block" data-accordion-item="">
                                    <a href="#ketmoravskoslezsky"  class="c-simple-accordion-title"><h3>EXPERTI RESORTU - MORAVSKOSLEZSKÝ KRAJ</h3></a>
                                ...
                                <li class="c-simple-accordion-item  content-block" data-accordion-item="">
                                    <a href="#ketjihocesky"  class="c-simple-accordion-title"><h3>EXPERTI RESORTU - JIHOČESKÝ KRAJ</h3></a>
                                ...
                                <li class="c-simple-accordion-item  content-block" data-accordion-item="">
                                    <a href="#ketplzensky"  class="c-simple-accordion-title"><h3>EXPERTI RESORTU - PLZEŇSKÝ KRAJ</h3></a>
                                ...
                                <li class="c-simple-accordion-item  content-block" data-accordion-item="">
                                    <a href="#ketustecky"  class="c-simple-accordion-title"><h3>EXPERTI RESORTU - ÚSTECKÝ KRAJ</h3></a>
                                ...
                                <li class="c-simple-accordion-item  content-block" data-accordion-item="">
                                    <a href="#ketkarlovarsky"  class="c-simple-accordion-title"><h3>EXPERTI RESORTU - KARLOVARSKÝ KRAJ</h3></a>
                                ...
                                <li class="c-simple-accordion-item  content-block" data-accordion-item="">
                                    <a href="#ketkralovehradecky"  class="c-simple-accordion-title"><h3>EXPERTI RESORTU - KRÁLOVÉHRADECKÝ KRAJ</h3></a>
                                ...
                                <li class="c-simple-accordion-item  content-block" data-accordion-item="">
                                    <a href="#ketjihomoravsky"  class="c-simple-accordion-title"><h3>EXPERTI RESORTU - JIHOMORAVSKÝ KRAJ</h3></a>
                                ...
                                <li class="c-simple-accordion-item  content-block" data-accordion-item="">
                                    <a href="#ketliberecky"  class="c-simple-accordion-title"><h3>EXPERTI RESORTU - LIBERECKÝ KRAJ</h3></a>
                                ...
                                <li class="c-simple-accordion-item  content-block" data-accordion-item="">
                                    <a href="#ketpardubicky"  class="c-simple-accordion-title"><h3>EXPERTI RESORTU - PARDUBICKÝ KRAJ</h3></a>
                                ...
                                <li class="c-simple-accordion-item  content-block" data-accordion-item="">
                                    <a href="#ketstredocesky"  class="c-simple-accordion-title"><h3>EXPERTI RESORTU - STŘEDOČESKÝ KRAJ</h3></a>
                                ...
                                <li class="c-simple-accordion-item  content-block" data-accordion-item="">
                                    <a href="#ketzlinsky"  class="c-simple-accordion-title"><h3>EXPERTI RESORTU - ZLÍNSKÝ KRAJ</h3></a>
                                ...
                                <li class="c-simple-accordion-item  content-block" data-accordion-item="">
                                    <a href="#ketpraha"  class="c-simple-accordion-title"><h3>EXPERTI RESORTU - HLAVNÍ MĚSTO PRAHA</h3></a>
